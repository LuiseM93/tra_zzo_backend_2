  ...
  return (
    <div className="bg-background text-on-background font-body-md min-h-screen p-8 md:p-16 max-w-4xl mx-auto">
      ...
      <div className="flex flex-col gap-6 text-on-surface-variant font-body-md text-body-md">
        ...
        <div>
          <h2 className="font-headline-lg-mobile text-headline-lg-mobile text-on-background mb-2">2. Autenticación y Cuentas</h2>
        ...
        <div>
          <h2 className="font-headline-lg-mobile text-headline-lg-mobile text-on-background mb-2">3. Pagos (Stripe)</h2>
        ...
        <div>
          <h2 className="font-headline-lg-mobile text-headline-lg-mobile text-on-background mb-2">4. Cambios a esta Política</h2>
